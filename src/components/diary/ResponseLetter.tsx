...
import { appendChatHistory, type DiaryRow, type ChatMessage } from "@/lib/diary-service";
...
export function DiaryDetail({ entry, onClose }: DiaryDetailProps) {
  const date = new Date(entry.created_at);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Diary content by module */}
          <section className="space-y-4">
            <h3 className="text-xs text-muted uppercase tracking-wider">我的记录</h3>
          ...
          {conversations.length > 0 && (
            <section className="space-y-4">
              <h3 className="text-xs text-muted uppercase tracking-wider">对话回响</h3>
